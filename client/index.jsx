...
class App extends React.Component {
  ...
  getDesciption() {
    $.ajax({
      method: 'GET',
      url: `http://${window.location.hostname}:3003/descriptions`,
      success: (data) => {
        this.setState({
          data,
        });
  ...
  getMensSizes() {
    $.ajax({
      method: 'GET',
      url: `http://${window.location.hostname}:3003/mensSizes`,
      success: (mens) => {
        this.setState({
          mensSizes: {
            mens,
  ...
  getWomensSizes() {
    $.ajax({
      method: 'GET',
      url: `http://${window.location.hostname}:3003/womensSizes`,
      success: (womens) => {
        this.setState({
          womensSizes: {
            womens,
  ...
  getEuSizes() {
    $.ajax({
      method: 'GET',
      url: `http://${window.location.hostname}:3003/euSizes`,
      success: (eu) => {
        this.setState({
          euSizes: {
            eu,
